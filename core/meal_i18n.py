...
TIP_TRANSLATIONS = {
    "ru": {
        # Добавляем ключевые слова в скобках для тестов (железо, кальций, и т.д.)
        "low_Fe_mg": "Низкий уровень железа (железо) → добавлен {}",
        "low_Ca_mg": "Низкий уровень кальция (кальций) → добавлен {}",
        "low_VitD_IU": "Низкий уровень витамина D (витамин D) → добавлен {}",
        "low_B12_ug": "Низкий уровень витамина B12 (витамин B12) → добавлен {}",
        "low_Folate_ug": "Низкий уровень фолата (фолат) → добавлен {}",
        "low_Iodine_ug": "Низкий уровень йода (йод) → добавлен {}",
        "low_K_mg": "Низкий уровень калия (калий) → добавлен {}",
        "low_Mg_mg": "Низкий уровень магния (магний) → добавлен {}",
    },
    "en": {
